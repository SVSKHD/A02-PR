"""
AUREON — MT5 broker adapter.

MT5Adapter wraps the MetaTrader5 terminal: stop/market order placement (incl. the
10030 -> FOK retry and the rc=-1 reconciliation), SL modify, position close, the
retcode name map, and broker tick-time offset autodetection. MetaTrader5 is imported
lazily inside __init__ so this module imports on non-Windows hosts (backtest/CI).
