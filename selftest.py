...
STEP_NAMES = {
    ...
    131: "R6 chop skip",
    # v3.5.0 all-16: utilities (8-11), strategy extras (12-14), hotfixes (15-16)
    132: "f8 pullback log",
    133: "f9 boost ledger",
    134: "f10 daily report",
    135: "f11 preflight",
    136: "util no-order-fx",
    137: "f12 confirm cand",
    138: "f13 atr depth",
    139: "f14 rescue sl wide",
    140: "f15 boost telem",
    141: "f16 offset no-0h",
    142: "strat full freeze",
    143: "per-flag indep",
    144: "rescue gate ON arm",
    145: "flag table check",
}
...
class SelfTest:
    ...
    def _break_gate_stub(self, getter, side='BUY', kind='RALLY', edge=100.0,
        ...
        # v3.5.0: silence the util-8/9 file writers during gate tests (they default ON);
        # the utilities are validated separately via their pure cores.
