"""
AUREON — Config dataclass (single tunable surface for the strategy).

Extracted verbatim from bot.py in the v3.0.0 structural refactor. PURE data:
no I/O, no imports beyond the stdlib dataclass machinery. version.py remains
the single source of truth for the version string; this holds strategy params.
"""
